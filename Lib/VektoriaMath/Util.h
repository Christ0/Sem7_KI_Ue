...
// Zahlenkonvertierung:
#define UM_HZ2SEC(x) (1/x) // Konvertiert Hertz zu Sekunden
#define UM_RAD2DEG(x) (x*180.0f/(float)PI) // Konvertiert Radians in Grad
#define UM_DEG2RAD(x) (x*(float)PI/180.0f) // Konvertiert Grad in Radians 
