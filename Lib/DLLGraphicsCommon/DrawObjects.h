...
namespace Vektoria
{
	...
	public:
		...
		void AddOver(unsigned int & id, int & idTexture, float & fDistanceToCameraSquare, CHMat & mGlobal, unsigned int * aiLightsAffectIndices, unsigned int & iLightsAffectCount);
