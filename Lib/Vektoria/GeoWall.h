...
public:
	...
	void InitWallTile(SWallTile & walltile);
	void InitWallSection(SWallSection & wallsection);
	...
	void Draw(float & fDistanceToCameraSquare, CHMat & mGlobal, CCamera *pcamera, int & iTick); // überladene Funktion wegen Subwindows
