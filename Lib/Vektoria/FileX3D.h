...
public:
	...
	void MakeMeshByTriangles(char * acIndexes, char * acPoints, CGeoTriangleList * ptrianglelist);
	void MakeMeshByFaces(char * acIndexes, char * acPoints, CGeoTriangleList * ptrianglelist);
